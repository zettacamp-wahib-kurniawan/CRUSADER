...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const db = {
    users: {
      u_wahib: {
        id: "u_wahib",
        name: "Wahib Kurniawan(Anda)",
        avatar: "assets/img/wahib_kurniawan.png",
      ...
      u_prof_doe: {
        id: "u_prof_doe",
        name: "Prof. Nabil Achmad",
        avatar: "assets/img/nabil_achmad.png",
        title: "Profesor Back End Developer",
        banner: "https://picsum.photos/id/1018/1000/250",
        erpData: { campus: "Zetta Jakarta" },
        hobbies: ["Data", "Backend Engineering"],
      },
      u_jerry: {
        id: "u_jerry",
        name: "Jerry Rahmanto (QA)",
        avatar: "assets/img/jerry_rahmanto.png",
        title: "QA Engineer",
